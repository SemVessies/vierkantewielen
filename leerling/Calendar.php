...
<div class="banner">
    <div class="navbar">
        ...
        <ul>
            <li><a href="http://localhost/VierkanteWielen/instructeur/instructeurCalendar.html">Kalender</a></li>
        </ul>
    </div>
</div>
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalLabel">Add New Les</h5>
...
<script>
            ...
            success: function (response) {
                ...
                $.each(result, function (i, item) {
                    les.push({
                        ...
                        // lesDatumEind: result[i].lesDatumEind,
                ...
                $('#calendar').fullCalendar({
                    ...
                    //     //alert(start);
                    //     //alert(end);
                    //     $('#lesDatum').val(moment(start).format('YYYY-MM-DD'));
                    //     $('#lesDatumEind').val(moment(end).format('YYYY-MM-DD'));
                    //     $('#event_entry_modal').modal('show');
                    // },
                    //les: les,
                    // eventRender: function (les, element, view) {
    ...
    function save_event() {
        ...
        // const lesDatumEind = $("#lesDatumEind").val();               lesDatumEind === "" ||
        const lesTijdBegin = $("#lesTijdBegin").val();
        const lesDuur = $("#lesDuur").val();
        const lesOpmerking = $("#lesOpmerking").val();
        // console.log(lesDoel,lesDatum,lesTijdBegin,lesDuur,lesOpmerking);
