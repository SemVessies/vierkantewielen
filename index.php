...
<div class="banner">
    <div class="navbar">
        <ul>
            ...
            <li><a href="http://localhost/VierkanteWielen/LoginPage.php">Login</a></li>
        </ul>
    </div>
</div>
<div class="pageContainer">
    <div class="contentWrap">
            ...
            <p>Wij van Vierkante Wielen geven iedereen de kans om een rijbewijs te halen. Zo zijn onze auto's en instructeurs voorzien van handig voorzieningen voor mensen met een lichamelijke beperking.</p>
        </div>
    </div>
    <footer class="footer">
        <div class="col-1">
